...
// 后端接口
live2d_settings['modelAPI']             = 'https://jx.teed.cc:8443/live2d/api/';   // 自建 API 修改这里
live2d_settings['tipsMessage']          = 'https://jx.teed.cc:8443/live2d/waifu-tips.json';            // 同目录下可省略路径
...
live2d_settings['screenshotCaptureName']= 'teed.cc.png'; // 看板娘截图文件名，例如 'live2d.png'
